...
namespace CloudCard.Models
{
    public class CloudCardService
    {
        ...
        private static async Task<Boolean> CheckCloudCardStatus()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Exception thrown checking CloudCard status.\n{e}");
                return false;
            }
        }
        ...
        public async Task<Person> PostPersonToCloudCard(string json)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"Posting the following JSON to /api/people: \n{json}\n");
